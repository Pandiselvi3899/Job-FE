...
export default class ApplList extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/appl/view", req, config)
      .then((response) => {
  ...
  onPress(value, appl) {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/appl/update", req, config)
      .then((response) => {
        alert(response.data);
  ...
  async Downloadfile(e) {
    try {
      const file = await axios.get("https://jobportal-mern.herokuapp.com/api/cv/get/" + e._id);
      var path = file.data.file_path;
      var mimetype = file.data.file_mimetype;
      const result = await axios.get("https://jobportal-mern.herokuapp.com/api/cv/download/" + e._id, {
        responseType: "blob",
      });
