...
export default class Apply extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/list/", { cond: { deadline: { $gte: new Date() } } }, config)
      .then((res) => {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/appl/", { cond: { uid: localStorage.getItem("id") } }, config)
      .then((res) => {
