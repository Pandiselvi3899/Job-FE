...
export default class AppProfile extends Component {
  ...
  onAddEdu(e) {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/user/edu/update", req, config)
      .then((response) => {})
      .catch((err) => {
  ...
  onAddBio(e) {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/user/profile", req, config)
      .then((response) => {})
      .catch((err) => {
        if (err.response.data) alert(err.response.data);
      });
  ...
  onAddPassword(e) {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/user/password", req, config)
      .then((response) => {
  ...
  onAddContact(e) {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/user/contact", req, config)
      .then((response) => {
  ...
  onAddName(e) {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/user/name", req, config)
      .then((response) => {
  ...
  onAddEmail(e) {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/user/email", req, config)
      .then((response) => {
  ...
  onDeleteSkill(ski) {
    ...
    axios.post("https://jobportal-mern.herokuapp.com/api/user/skills/delete", req, config).then((res) => {});
    window.location.href = "/profile";
  }
  onChangeSkill(event) {
  ...
  onDeleteEdu(edu) {
    ...
    axios.post("https://jobportal-mern.herokuapp.com/api/user/edu/delete", req, config).then((res) => {});
    window.location.href = "/profile";
  }
  async Downloadfile() {
    try {
      const file = await axios.get("https://jobportal-mern.herokuapp.com/api/cv/get/" + localStorage.getItem("id"));
      var path = file.data.file_path;
      var mimetype = file.data.file_mimetype;
      const result = await axios.get(
        "https://jobportal-mern.herokuapp.com/api/cv/download/" + localStorage.getItem("id"),
        {
          responseType: "blob",
        }
      );
  ...
  async onCV(e) {
    ...
    try {
      await axios.post("https://jobportal-mern.herokuapp.com/api/cv/upload", formData, {
  ...
  async onDP(e) {
    ...
    formData.append("uid", id);
    try {
      await axios.post("https://jobportal-mern.herokuapp.com/api/dp/upload", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
    } catch (error) {
      if (error.response) alert(error.response.data);
  ...
  onSubmit(e) {
    ...
    axios
      .post("https://jobportal-mern.herokuapp.com/api/user/skills/add/", req, config)
      .then((response) => {
  ...
  componentDidMount() {
    ...
    axios.get("https://jobportal-mern.herokuapp.com/api/user/edu", config).then((res) => {
      this.setState({ edus: res.data });
    });
    axios.get("https://jobportal-mern.herokuapp.com/api/user/skills", config).then((res) => {
      this.setState({ skills: res.data });
    });
    axios.get("https://jobportal-mern.herokuapp.com/api/user/auth", config).then(async (res) => {
      this.setState({ user: res.data });
      if (this.state.user.dp) {
        try {
          const result = await axios.get(
            "https://jobportal-mern.herokuapp.com/api/dp/download/" + localStorage.getItem("id"),
            {
              responseType: "blob",
            }
          );
